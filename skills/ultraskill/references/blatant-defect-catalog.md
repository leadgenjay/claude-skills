...
Expanded checklists for the heal pathway's blatant-defect scan (`references/heal.md`, Step 1). Each defect includes detection method, common false positives, and severity.
