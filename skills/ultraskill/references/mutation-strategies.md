...
| Failed Assertion | Mutation |
|---|---|
| "PAS framework used" | Add example block: "**Good (PAS):** Problem: 'You're sending 500 cold emails and getting 0 replies.' Agitation: 'Every day without replies costs you 2,400 USD in lost revenue.' Solution: 'The Machine books 47 meetings/month on autopilot.' **Bad:** Starting with features or company description." |
