...
### 6. ❌ Wrong: Agent node typeVersion ≤ 2.2
```
Agent node at typeVersion 2.2 → Think tool schema broken
Both Anthropic and OpenAI reject: "Invalid schema for function 'Think'"
```

### ✅ Correct: Upgrade to typeVersion 3
```javascript
{
  type: "@n8n/n8n-nodes-langchain.agent",
  typeVersion: 3  // Fixes Think tool schema — no other changes needed
}
```
